      ...
      <div className="container mx-auto px-4">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-8 mb-8">
            <div className="text-center">
              <p className="text-zen-accent dark:text-zen-accent-dark font-medium">Téléphone</p>
              <a 
            ...
            <div className="text-center">
              <p className="text-zen-accent dark:text-zen-accent-dark font-medium">Email</p>
              <a 
            ...
            <div className="text-center">
              <p className="text-zen-accent dark:text-zen-accent-dark font-medium">Localisation</p>
