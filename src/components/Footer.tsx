...
const Footer = () => {
  return (
    <footer className="bg-zen-primary/10 text-foreground py-12" role="contentinfo">
      <div className="container mx-auto px-4">
        <div className="text-center">
          <div className="flex items-center justify-center space-x-2 mb-6">
            <Heart className="h-6 w-6 text-zen-accent" aria-hidden="true" />
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-8 mb-8">
            <div className="text-center">
              ...
              <a 
                ...
                className="text-foreground/80 hover:text-zen-accent transition-colors duration-300"
            ...
            <div className="text-center">
              ...
              <p className="text-foreground/80">Lille, Nord</p>
            </div>
          </div>
