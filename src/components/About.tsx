          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 text-left">
              <p className="text-lg text-foreground/80 leading-relaxed">
                Bienvenue dans mon univers dédié à la beauté et à la sérénité à Lille. 
              ...
              <p className="text-lg text-foreground/80 leading-relaxed">
                Mon salon à domicile dans le Nord est pensé comme un cocon de douceur, 
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-zen-accent rounded-full mr-4" aria-hidden="true"></div>
                  <span className="text-foreground">Produits haut de gamme et naturels</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-zen-accent rounded-full mr-4" aria-hidden="true"></div>
                  <span className="text-foreground">Environnement 100% zen et relaxant</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-zen-accent rounded-full mr-4" aria-hidden="true"></div>
                ...
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-zen-accent rounded-full mr-4" aria-hidden="true"></div>
                  <span className="text-foreground">Respect total de votre intimité</span>
                </div>
              </div>
            </div>
            
            <div className="zen-card-gradient p-8 rounded-2xl shadow-lg">
              <blockquote className="text-foreground/80 italic text-lg mb-4 leading-relaxed">
              ...
              <cite className="text-zen-accent font-semibold not-italic">
