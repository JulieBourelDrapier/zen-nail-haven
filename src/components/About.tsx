    ...
    <section id="about" className="py-20 zen-gradient">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          <h2 className="text-3xl md:text-4xl font-bold text-zen-forest mb-8">
            Un Espace Pensé pour Votre Bien-être
          </h2>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 text-left">
              <p className="text-lg text-zen-forest/80 leading-relaxed">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-zen-sage rounded-full mr-4" aria-hidden="true"></div>
                  <span className="text-zen-forest">Produits haut de gamme et naturels</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-zen-sage rounded-full mr-4" aria-hidden="true"></div>
                  <span className="text-zen-forest">Environnement 100% zen et relaxant</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-zen-sage rounded-full mr-4" aria-hidden="true"></div>
                  <span className="text-zen-forest">Accompagnement personnalisé</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-zen-sage rounded-full mr-4" aria-hidden="true"></div>
                  <span className="text-zen-forest">Respect total de votre intimité</span>
                </div>
              </div>
            </div>
            
            <div className="zen-card-gradient p-8 rounded-2xl shadow-lg">
              <blockquote className="text-zen-forest/80 italic text-lg mb-4 leading-relaxed">
              ...
              <cite className="text-zen-sage font-semibold not-italic">
